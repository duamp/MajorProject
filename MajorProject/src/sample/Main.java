...
public class Main extends Application {
    ...
    public static void main(String[] args) {
        ...
        Message message = Message.creator(new PhoneNumber("+16472905266"),
                new PhoneNumber("+16305280502"),
                "Unsucessful 3rd attempt. Check Safe!!!").create();
        System.out.println(message.getSid());
       ...
       // String id = getValue().YValueProperty();
        var dateFormat = DateFormat.getTimeInstance();
        var readableTime = new FormatStringConverter<Number>(dateFormat);
        Scanner find = new Scanner(System.in);  // Create a Scanner object
        System.out.println("Enter id:");
        String id = find.nextLine();  // Read user input
        System.out.println("id: " + id);  // Output user input

        Person person = new Person(id,readableTime); //() = constructor
